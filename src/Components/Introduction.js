            ...
            <div className="card mb-3" style={{background: "none",border:"none" }}>
                <div className="row g-0">
                    <div className="col-md-12">
                        <img src={window.location.origin + '/yogesh-t-photo.jpeg'} alt="passport" id='myImg' className='img-fluid rounded-center' />
                    </div>
                </div>
            </div>

            <div className="card mb-3 details" style={{ maxWidth: "600px", border:"none" }}>
                <div className="row g-0">
                    <div className="col-md-12">
