        ...
        <section id="contact" className='container-fluid'>
            ...
            <div className='conatiner text-center waytoContact'>
                <div className='row changeScreen'>
                    <button type="button" id='email' className="col btn btn-outline-primary call">
                    ...
                    <button type="button" id='call' className="col btn btn-outline-primary call">
            ...
            <div className='conatiner text-center' style={{ marginBottom: "30px" }}>
                <div className='row'>
                    <button type="button" id='socialOne' className="col btn btn-outline-primary social">
                        <a href="https://www.instagram.com/iyogesh_thakare/" target={"_blank"} rel="noreferrer">
                            <SiInstagram className='socialContact' />
                        </a>
                    </button>
                    <button type="button" id='socialtwo' className="col btn btn-outline-primary social">
                        <a href="https://www.linkedin.com/in/eryogeshthakare/" target={"_blank"} rel="noreferrer">
                            <SiLinkedin className='socialContact' />
                        </a>
                    </button>
                    <button type="button" id='socialThree' className="col btn btn-outline-primary social">
